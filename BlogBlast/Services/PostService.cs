...
public interface IPostService
{
    ...
    /// <returns>An array of posts based on the specified page index, page size, and category ID.</returns>
    Task<Post[]> GetAllPostsAsync(int pageIndex, int pageSize, int categoryId = 0);
}
